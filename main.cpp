...
int main() {
  ...
  float sumatotal,costo,cables=0,preciomaterial,preciomaterial1,cableconect,ganancia,total;
  ...
  for (i=1;i<=puntos;i=i+1){
    ...
    cout<<"Ingrese la distancia entre el conector de punto de red hasta el equipo de conectividad"<<endl;
    cin>>distancia;
